...
const SOURCE_BADGE: Record<AdjustmentSource, { label: string; cls: string; Icon: typeof Hand }> = {
  ...
  ai: { label: 'AI', cls: 'bg-[#EFF6FF] text-[#0052FF]', Icon: Sparkles },
};
                    ...
                    <td colSpan={fos ? 7 : 6} className="px-3 py-1 text-right">
                      {sectionAISuggestionCount > 0 && (
                        <button
                          ...
                          className="text-[11px] px-2 py-0.5 rounded border border-[#0052FF] bg-[#EFF6FF] text-[#0052FF] hover:bg-[#EFF6FF] mr-1.5"
                        >
                        ...
                        <td className="text-right px-3 py-2 tabular-nums">
                          {sug ? (
                            <div className="flex items-center justify-end gap-1.5">
                              <span title={sug.reason || ''} className="text-[#0052FF] font-semibold">
                          ...
                          <Popover>
                            ...
                            <PopoverContent className="w-44 p-1" align="end">
                              ...
                              {sug && (
                                <button
                                  onClick={() => onChange(acc, sug.suggested_value, 'ai', sug)}
                                  className="w-full text-left px-2 py-1.5 text-xs rounded hover:bg-[#EFF6FF] text-[#0052FF]"
                                >
                                  Till AI-förslag
                                </button>
                              )}

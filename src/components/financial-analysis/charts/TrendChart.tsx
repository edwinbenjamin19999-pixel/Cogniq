  ...
  return (
    <ResponsiveContainer width="100%" height={300}>
      <ComposedChart data={monthlyTrend} margin={{ top: 8, right: 8, left: -8, bottom: 8 }}>
        ...
        <Line type="monotone" dataKey="Intäkter" stroke="#000000" strokeWidth={2.5} dot={{ r: 3 }} />
        <Line type="monotone" dataKey="Kostnader" stroke="#525252" strokeWidth={2.5} dot={{ r: 3 }} />
        <Line type="monotone" dataKey="EBIT" stroke="#000000" strokeWidth={2.5} dot={{ r: 3 }} />
        {hasBudget && (
          <>
            <Line type="monotone" dataKey="BudgetIntäkter" stroke="#000000" strokeWidth={1.5} strokeDasharray="4 4" dot={false} />
            <Line type="monotone" dataKey="BudgetKostnader" stroke="#525252" strokeWidth={1.5} strokeDasharray="4 4" dot={false} />
            <Line type="monotone" dataKey="BudgetEBIT" stroke="#000000" strokeWidth={1.5} strokeDasharray="4 4" dot={false} />
          </>
        )}
      </ComposedChart>
    </ResponsiveContainer>

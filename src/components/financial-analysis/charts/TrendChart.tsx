  ...
  return (
    <ResponsiveContainer width="100%" height={300}>
      <ComposedChart data={monthlyTrend} margin={{ top: 8, right: 8, left: -8, bottom: 8 }}>
        ...
        <Line type="monotone" dataKey="EBIT" stroke="#0052FF" strokeWidth={2.5} dot={{ r: 3 }} />
        {hasBudget && (
          <>
            ...
            <Line type="monotone" dataKey="BudgetEBIT" stroke="#0052FF" strokeWidth={1.5} strokeDasharray="4 4" dot={false} />
          </>
        )}
      </ComposedChart>
    </ResponsiveContainer>

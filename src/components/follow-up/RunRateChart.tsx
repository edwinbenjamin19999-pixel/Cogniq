  ...
  return (
    <div className="rounded-2xl border border-slate-200 bg-white shadow-sm p-5 animate-in fade-in slide-in-from-bottom-2">
      ...
      <div className="h-72">
        <ResponsiveContainer width="100%" height="100%">
          ...
          >
            ...
            <Line type="monotone" dataKey="actual" name="Utfall" stroke="#0052FF" strokeWidth={2.5} dot={{ r: 3 }} activeDot={{ r: 5 }} />
            <Line type="monotone" dataKey="forecast" name="Prognos" stroke="#0052FF" strokeWidth={2} strokeDasharray="6 4" dot={{ r: 2 }} />
      ...
      <div className="mt-3 flex flex-wrap gap-4 text-xs text-slate-600">
        <span className="inline-flex items-center gap-1.5"><span className="h-0.5 w-4 bg-[#0052FF]" /> Utfall</span>
        <span className="inline-flex items-center gap-1.5"><span className="h-0.5 w-4 bg-[#0052FF] [border-top:1px_dashed]" /> Prognos</span>

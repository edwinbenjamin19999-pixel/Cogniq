    ...
    <div className="flex items-center gap-3">
      <Tabs value={mode} onValueChange={(v) => onModeChange(v as FollowUpMode)}>
        <TabsList className="bg-slate-100">
          <TabsTrigger value="live" className="data-[state=active]:bg-[#0052FF] data-[state=active]:text-white">
            Live
          </TabsTrigger>
          <TabsTrigger
            value="live_forecast"
            className="data-[state=active]:bg-[#0052FF] data-[state=active]:text-white"
          >
            Live Forecast
          </TabsTrigger>
          <TabsTrigger value="month" className="data-[state=active]:bg-[#0052FF] data-[state=active]:text-white">
            Månad
          </TabsTrigger>
        </TabsList>
      </Tabs>

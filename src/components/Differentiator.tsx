...
export const Differentiator = () => {
  return (
    <section className="py-20 sm:py-28 bg-gradient-to-b from-[#000000] to-[#0a1428] overflow-hidden">
      <div className="container mx-auto px-4 sm:px-6">
        <div className="text-center mb-14">
          ...
          >
            Från manuellt till{" "}
            <span className="text-[#000000]">automatiserat</span>
          </h2>
        ...
        <div className="grid sm:grid-cols-2 gap-6 max-w-3xl mx-auto">
          ...
          {/* Bokfy */}
          <div className="rounded-2xl border border-[rgba(0,0,0,0.2)] bg-[rgba(0,0,0,0.06)] p-7 shadow-[0_0_40px_rgba(0,0,0,0.08)]">
            <div className="flex items-center gap-2 mb-6">
              <h3 className="text-sm font-semibold text-[#000000] uppercase tracking-wider">
                Bokfy
              </h3>
              <span className="text-[10px] font-semibold px-2 py-0.5 rounded-full bg-[rgba(0,0,0,0.1)] text-[#000000] border border-[rgba(0,0,0,0.2)]">
                Autonom
              </span>
            </div>
            <ul className="space-y-4">
              {northledger.map((item) => (
                <li key={item} className="flex items-center gap-3 text-white/80">
                  <Check className="w-4 h-4 text-[#000000] flex-shrink-0" />
                  <span className="text-[14px]">{item}</span>
                </li>
              ))}
            </ul>
            <div className="mt-6 pt-4 border-t border-[rgba(0,0,0,0.1)]">
              <p className="text-[12px] text-[#000000]">Tid per månad: ~5 minuter</p>
            </div>
          </div>
        </div>
        ...
        <div className="text-center mt-10">
          <Button
            className="h-12 px-8 rounded-xl text-[15px] font-semibold bg-gradient-to-r from-[#000000] to-[#000000] text-white hover:brightness-110 shadow-[0_4px_24px_rgba(0,0,0,0.4)] hover:scale-[1.02] transition-all duration-200"

          ...
          {chartData.length > 0 ? (
            <div className={`bg-white rounded-2xl border border-slate-100 shadow-[0_2px_16px_rgba(0,0,0,0.06)] hover:shadow-[0_4px_24px_rgba(0,0,0,0.10)] transition-shadow duration-300 p-6 h-64`}>
              ...
              <ChartGradients />
                  ...
                  <Bar dataKey="customerPays" name="Kunddel" fill="#0052FF" radius={[6, 6, 0, 0]} />
                  <Bar dataKey="deduction" name="Avdragsdel" fill={settings.rot_enabled ? "#10b981" : "#0052FF"} radius={[6, 6, 0, 0]} />
                </BarChart>
              </ResponsiveContainer>
            </div>
          ) : (

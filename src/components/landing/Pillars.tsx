...
const pillars = [
  {
    icon: Bot,
    tint: "bg-neutral-100 hover:bg-neutral-200",
    iconCircle: "bg-[#000000] text-white",
  ...
  {
    icon: Landmark,
    tint: "bg-neutral-100 hover:bg-neutral-100",
    iconCircle: "bg-[#000000] text-white",
  ...
  },
  {
    icon: CreditCard,
    tint: "bg-neutral-100 hover:bg-neutral-100",
    iconCircle: "bg-[#525252] text-[#000000]",
  ...
  return (
    <section className="bg-white py-24">
      <div className="mx-auto max-w-7xl px-6">
        <p className="text-xs font-semibold uppercase tracking-[0.15em] text-[#000000]">
          Plattformen
        </p>
        <h2 className="mt-3 text-3xl md:text-4xl font-extrabold tracking-tight text-[#000000]">
        ...
        <div className="mt-12 grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-4">
          {pillars.map((p) => (
            ...
            >
              ...
              <h3 className="mt-6 text-base font-bold text-[#000000]">{p.title}</h3>
              <p className="mt-2 text-sm leading-relaxed text-[#000000]/60">{p.desc}</p>
            </div>
          ))}
        </div>
      </div>

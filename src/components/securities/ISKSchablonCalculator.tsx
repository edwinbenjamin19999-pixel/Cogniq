    ...
    <Card className="p-6">
      <div className="flex items-center gap-2 mb-4">
        <div className="p-2 rounded-lg bg-[#EFF6FF] dark:bg-blue-950/40">
          <Calculator className="h-5 w-5 text-[#0052FF] dark:text-[#0052FF]" />
        </div>
        <div>
      ...
      <div className="rounded-lg border bg-muted/30 p-4 space-y-2">
        ...
        <div className="flex justify-between text-sm pt-2 border-t">
          ...
          <span className="tabular-nums font-bold text-[#0052FF] dark:text-[#0052FF]">{formatSEK(result.taxAmount)}</span>
        </div>

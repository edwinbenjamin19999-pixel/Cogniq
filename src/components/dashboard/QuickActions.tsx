        ...
        {actions.map((action, index) => {
          ...
          return (
            <button
              ...
              className="group bg-card border border-border hover:border-black/40 hover:shadow-[0_4px_12px_rgba(20,184,166,0.08)] hover:-translate-y-0.5 rounded-xl p-4 cursor-pointer transition-all duration-[160ms] ease-out flex flex-col items-center gap-3 text-center active:scale-[0.99]"
            >
              <div className="w-11 h-11 rounded-lg flex items-center justify-center bg-muted/60 border border-border group-hover:border-black/40 transition-colors">
                <Icon className="w-5 h-5 text-muted-foreground group-hover:text-black transition-colors" strokeWidth={1.75} />
              </div>
              <div>

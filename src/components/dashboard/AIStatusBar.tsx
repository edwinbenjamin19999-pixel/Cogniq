...
export const AIStatusBar = () => {
  ...
  return (
    <div className="flex items-center gap-3 rounded-xl border border-black/60 bg-[#0F1F3D] px-4 py-2.5">
      ...
      <p className="text-sm font-medium text-[#000000] flex-shrink-0">
        AI analyserar din ekonomi i realtid
      </p>
      <span className="text-[#000000]">·</span>
      <p key={status} className="text-sm text-[#000000] animate-fade-in truncate">{status}</p>
    </div>
  );
};

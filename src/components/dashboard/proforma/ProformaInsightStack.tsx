...
const TONE = {
  ...
  positive: { bg: "bg-blue-50/70 dark:bg-blue-950/30", border: "border-blue-200/60 dark:border-[#0052FF]/40", iconBg: "bg-[#EFF6FF]", iconColor: "text-[#0052FF] dark:text-[#1E3A5F]", Icon: TrendingUp },
    ...
    <div className="space-y-3">
      <div className={cn("rounded-2xl border px-5 py-4 flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4", tone.bg, tone.border)}>
        ...
        {primary.tone === "positive" && !primary.actionLabel && (
          <CheckCircle2 className="w-5 h-5 text-[#0052FF] shrink-0 hidden sm:block" />
        )}
      </div>

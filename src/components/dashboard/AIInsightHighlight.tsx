...
export const AIInsightHighlight = ({ companyId }: AIInsightHighlightProps) => {
  ...
  if (data.status === "loading" || data.status === "no-data") {
    return (
      <div className="relative rounded-2xl overflow-hidden">
        <div className="absolute inset-0 bg-[#0052FF]/15 rounded-2xl" />
        <div className="absolute inset-[1px] rounded-2xl bg-card" />
        <div className="relative p-5 flex items-center gap-4">
          <div className="w-10 h-10 rounded-xl bg-[#0052FF]/20 flex items-center justify-center flex-shrink-0">
  ...
  const trendColor = isPositive ? "text-[#0052FF]" : "text-[#7A5417]";
  ...
  return (
    <div className="relative rounded-2xl overflow-hidden">
      <div className="absolute inset-0 bg-[#0052FF]/20 rounded-2xl" />
      <div className="absolute inset-[1px] rounded-2xl bg-card" />
      <div className="relative p-5 space-y-3">
        ...
        <div className="flex items-center justify-between pl-14 pt-2 border-t border-border/30">
          ...
          <Button
            variant="ghost"
            size="sm"
            className="text-[#0052FF] hover:text-[#0052FF] hover:bg-[rgba(0,82,255,0.1)] flex-shrink-0 h-7 text-xs"

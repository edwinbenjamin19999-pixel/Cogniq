...
export const ALL_KPIS: KpiDefinition[] = [
  ...
  { id: 'result', label: 'Resultat (EBIT)', category: 'LÖNSAMHET', suffix: ' kr', prefix: '', accentColor: '#0052FF', icon: 'BarChart3', navigateTo: '/reports' },
  { id: 'margin', label: 'Bruttomarginal', category: 'LÖNSAMHET', suffix: '%', prefix: '', accentColor: '#0052FF', icon: 'BarChart3', navigateTo: '/reports' },
  ...
  // PERSONAL & SKATT
  { id: 'payroll', label: 'Löner & personalkostnader', category: 'PERSONAL & SKATT', suffix: ' kr', prefix: '', accentColor: '#0040CC', icon: 'Users', navigateTo: '/hr' },

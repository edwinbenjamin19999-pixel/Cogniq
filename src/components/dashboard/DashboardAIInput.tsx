      ...
      <div className="rounded-2xl border border-border bg-card/95  shadow-[0_8px_40px_rgba(0,0,0,0.15)] overflow-hidden">
        {(response || loading) && (
          <div className="px-4 pt-3 pb-2 border-b border-border">
            <div className="flex items-start gap-2">
              <Sparkles className="w-3.5 h-3.5 text-[#0052FF] mt-0.5 flex-shrink-0" />
        ...
        <form onSubmit={handleSubmit} className="flex items-center gap-2 p-3">
          ...
          <Button
            ...
            className="w-8 h-8 rounded-lg bg-gradient-to-r from-[#0052FF] to-[#0052FF] text-white hover:brightness-110 flex-shrink-0"
          >

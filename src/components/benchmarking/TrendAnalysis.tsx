        ...
        <CardContent>
          <ResponsiveContainer width="100%" height={350}>
            <LineChart data={trendData}>
              ...
              <Line type="monotone" dataKey="ebitda" name="Ditt bolag" stroke="#0052FF" strokeWidth={2.5} dot={{ r: 3 }} />
        ...
        <CardContent>
          <ResponsiveContainer width="100%" height={300}>
            <LineChart data={trendData}>
              ...
              <Line type="monotone" dataKey="dso" name="Ditt bolag" stroke="#0052FF" strokeWidth={2.5} dot={{ r: 3 }} />
            </LineChart>
          </ResponsiveContainer>
        </CardContent>
      </Card>

    ...
    <div className="space-y-8" onPaste={handlePaste}>
      ...
      <Tabs defaultValue="upload">
        <TabsList className="flex-wrap h-auto gap-0 rounded-none bg-transparent p-0 border-b-[0.5px] border-[#E2E8F0] w-full justify-start">
          <TabsTrigger value="upload" className="gap-1.5 rounded-none bg-transparent text-[#475569] border-b-2 border-transparent px-[14px] py-[8px] data-[state=active]:bg-transparent data-[state=active]:text-[#000000] data-[state=active]:font-medium data-[state=active]:border-[#000000] data-[state=active]:shadow-none -mb-px"><Upload className="h-4 w-4" />Kvittohantering</TabsTrigger>
          <TabsTrigger value="batch" className="gap-1.5 rounded-none bg-transparent text-[#475569] border-b-2 border-transparent px-[14px] py-[8px] data-[state=active]:bg-transparent data-[state=active]:text-[#000000] data-[state=active]:font-medium data-[state=active]:border-[#000000] data-[state=active]:shadow-none -mb-px"><Layers className="h-4 w-4" />Batchbearbetning</TabsTrigger>
          <TabsTrigger value="mileage" className="gap-1.5 rounded-none bg-transparent text-[#475569] border-b-2 border-transparent px-[14px] py-[8px] data-[state=active]:bg-transparent data-[state=active]:text-[#000000] data-[state=active]:font-medium data-[state=active]:border-[#000000] data-[state=active]:shadow-none -mb-px"><Car className="h-4 w-4" />Körjournal</TabsTrigger>
          <TabsTrigger value="reports" className="gap-1.5 rounded-none bg-transparent text-[#475569] border-b-2 border-transparent px-[14px] py-[8px] data-[state=active]:bg-transparent data-[state=active]:text-[#000000] data-[state=active]:font-medium data-[state=active]:border-[#000000] data-[state=active]:shadow-none -mb-px"><FileBarChart className="h-4 w-4" />Utläggsrapporter</TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="upload" className="mt-4 space-y-6">
          ...
          <Card
            className={`group border-[2px] border-dashed transition-all duration-300 cursor-pointer rounded-[12px] ${ dragOver
              ...
              : "border-[#E2E8F0] bg-white hover:border-[#000000] hover:bg-[#F5F9FF]"
            }`}
          ...
          >
            <CardContent className="py-16 text-center">
              <div className="flex flex-col items-center gap-4">
                <Upload size={32} strokeWidth={1} className="text-[#94A3B8] group-hover:text-[#000000] transition-colors" />
                <div>
                ...
                <div className="flex flex-wrap items-center justify-center gap-2">
                  <span className="px-[10px] py-[3px] rounded-full bg-[#000000] text-[#E6F4FA] text-[11px] font-medium flex items-center gap-1.5">
                    <span className="w-[18px] h-[18px] rounded-full bg-[#E6F4FA] text-[#000000] text-[10px] font-medium flex items-center justify-center">1</span>
                    Extrahera data
                  </span>
                  <span className="text-[#E2E8F0]">→</span>
                  <span className="px-[10px] py-[3px] rounded-full bg-[#000000] text-[#E6F4FA] text-[11px] font-medium flex items-center gap-1.5">
                    <span className="w-[18px] h-[18px] rounded-full bg-[#E6F4FA] text-[#000000] text-[10px] font-medium flex items-center justify-center">2</span>
                    Detektera moms
                  </span>
                  <span className="text-[#E2E8F0]">→</span>
                  <span className="px-[10px] py-[3px] rounded-full bg-[#000000] text-[#E6F4FA] text-[11px] font-medium flex items-center gap-1.5">
                    <span className="w-[18px] h-[18px] rounded-full bg-[#E6F4FA] text-[#000000] text-[10px] font-medium flex items-center justify-center">3</span>
                    Föreslå konton
                  </span>
                  <span className="text-[#E2E8F0]">→</span>
                  <span className="px-[10px] py-[3px] rounded-full bg-[#000000] text-[#E6F4FA] text-[11px] font-medium flex items-center gap-1.5">
                    <span className="w-[18px] h-[18px] rounded-full bg-[#E6F4FA] text-[#000000] text-[10px] font-medium flex items-center justify-center">4</span>
                    Matcha betalning
                  </span>
                </div>
                <Button className="bg-[#000000] hover:bg-[#1074A0] text-[#E6F4FA] rounded-[8px] text-[12px] font-medium px-[14px] h-[34px]" onClick={(e) => { e.stopPropagation(); fileInputRef.current?.click(); }}>
          ...
          {/* AI Insights Bar */}
          {results.length > 0 && (
            <div className="bg-[#0F1F3D] border border-black/50 rounded-2xl px-5 py-3">
              <div className="flex items-center gap-6 flex-wrap">
                <div className="flex items-center gap-2">
                  <Sparkles className="h-4 w-4 text-[#000000]" />
                  <span className="text-sm font-medium text-[#000000]">AI-insikter</span>
                </div>
          ...
          {results.length === 0 && (
            <Card className="rounded-[12px] bg-white border-[2px] border-dashed border-[#E2E8F0] hover:border-[#000000] hover:bg-[#F5F9FF] transition-colors overflow-hidden relative">
              <CardContent className="py-16 text-center relative z-10">
                {/* AI illustration */}
                <div className="relative w-24 h-24 mx-auto mb-6">
                  <div className="absolute inset-2 rounded-xl bg-[#F5F9FF] flex items-center justify-center">
                    <ScanLine className="h-10 w-10 text-[#000000] animate-[pulse_2s_ease-in-out_infinite]" />
                  </div>
                  ...
                  <div className="absolute -right-6 -top-2 w-14 bg-white rounded-lg shadow-lg p-1.5 border-[0.5px] border-[#E2E8F0] animate-[bounce_3s_ease-in-out_infinite]">
                    <div className="space-y-1">
                      ...
                      <div className="text-[6px] font-bold text-[#000000] text-right">1 249 kr</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-center gap-2 mb-6">
                  <div className="flex items-center gap-1.5 px-[10px] py-[3px] rounded-full bg-[#000000] text-[#E6F4FA] text-[11px] font-medium">
                    <span className="w-[18px] h-[18px] rounded-full bg-[#E6F4FA] text-[#000000] text-[10px] font-medium flex items-center justify-center">1</span>
                    Släpp kvitto
                  </div>
                  <span className="text-[#E2E8F0]">→</span>

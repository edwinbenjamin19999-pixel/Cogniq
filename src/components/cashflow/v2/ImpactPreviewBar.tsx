...
export function ImpactPreviewBar({
  ...
  if (pending.length === 0) {
    return (
      <div className="fixed bottom-4 left-1/2 -translate-x-1/2 z-40 rounded-full bg-[#0052FF] text-white px-4 py-2 shadow-lg flex items-center gap-2 text-xs">
    ...
    <div className="fixed bottom-4 left-4 right-4 z-40 max-w-5xl mx-auto rounded-2xl border bg-background/95 backdrop-blur shadow-lg">
      <div className="p-4 flex items-center gap-4 flex-wrap">
        <div className="flex items-center gap-2">
          <Beaker className="h-4 w-4 text-[#0052FF]" />

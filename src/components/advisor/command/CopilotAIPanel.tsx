    ...
    <div className="bg-white border-[0.5px] border-[#E2E8F0] rounded-[12px] p-[14px] shadow-sm">
      ...
      <form onSubmit={handleSubmit} className="mt-3 flex items-center gap-2 pt-3 border-t border-[#E2E8F0]">
        ...
        <button
          ...
          className="bg-[#000000] hover:bg-[#1074A0] disabled:bg-[#CBD5E1] text-[#E6F4FA] rounded-[8px] text-[11px] font-medium px-[10px] h-[28px] flex items-center gap-1"
        >
      ...
      {lastAssistant?.content && !streaming && (
        <div className="mt-2 flex items-center gap-3 text-[10px]">
          <button
            ...
            className="text-[#475569] hover:text-[#000000] flex items-center gap-1"
          >

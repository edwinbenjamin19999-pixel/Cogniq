...
const TONE_CFG = {
  strong: { ring: "from-neutral-700/30 to-[#000000]/20", chip: "bg-[#E1F5EE] text-[#085041] dark:text-neutral-300", Icon: TrendingUp },
  watch: { ring: "from-neutral-700/30 to-orange-400/20", chip: "bg-[#FAEEDA] text-[#7A5417] dark:text-neutral-300", Icon: AlertTriangle },
  risk: { ring: "from-neutral-700/30 to-orange-400/20", chip: "bg-[#FCE8E8] text-[#7A1A1A] dark:text-neutral-300", Icon: TrendingDown },
  neutral: { ring: "from-[#000000]/30 to-neutral-700/20", chip: "bg-[#EFF6FF] text-[#000000] dark:text-[#000000]", Icon: Sparkles },
} as const;
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl border border-border bg-card text-card-foreground shadow-sm">
      ...
      <div className="relative p-6 md:p-8">
        ...
        <h2
          className="tracking-tight max-w-3xl text-[#000000] dark:text-foreground"
        ...
        {bullets.length > 0 && (
          <ul className="mt-5 grid grid-cols-1 md:grid-cols-2 gap-2.5" style={{ maxWidth: 720 }}>
            {bullets.slice(0, 4).map((b, i) => (
              ...
              >
                <span className="mt-2.5 h-1.5 w-1.5 rounded-full bg-[#000000] shrink-0" />
                <span>{b}</span>
              </li>
            ))}
          </ul>

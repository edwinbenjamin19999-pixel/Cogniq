...
export function AlertsStrip({ companyId }: Props) {
  ...
  if (items.length === 0) {
    return (
      <section className="rounded-2xl border border-emerald-200/40 dark:border-emerald-800/30 bg-white dark:from-emerald-950/20 dark:to-blue-950/10 p-5 md:p-6 h-full flex items-center gap-3">

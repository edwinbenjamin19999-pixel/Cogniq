...
export const InvoiceRecommendationsCard = ({
  ...
  return (
    <div className="rounded-2xl bg-white border border-slate-200/70 border-l-[3px] border-l-[#0052FF] shadow-[0_1px_3px_rgba(15,23,42,0.04)] hover:shadow-md transition-shadow p-5">
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          <ul className="space-y-2">
            {recs.map((r, i) => {
              const Icon = r.icon;
              const toneText = r.tone === "rose" ? "text-[#7A1A1A]" : "text-[#0052FF]";

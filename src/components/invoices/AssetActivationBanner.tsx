...
export const AssetActivationBanner = ({ invoiceId, totalAmount, threshold = 10000 }: Props) => {
  ...
  return (
    <div className="mx-4 sm:mx-8 mt-4 rounded-[12px] border-[0.5px] border-[#0052FF]/30 bg-[#0052FF]/5 p-4">
      <div className="flex items-start gap-3">
        <Sparkles className="w-5 h-5 text-[#0052FF] mt-0.5 shrink-0" />
        <div className="flex-1 min-w-0">
          ...
          <div className="flex gap-2 mt-3">
            <Button
              size="sm"
              className="h-8 bg-[#0052FF] hover:bg-[#0052FF] text-white"
              onClick={() =>
                navigate(

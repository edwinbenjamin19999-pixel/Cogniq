...
export const MistakesCallout = ({ items }: MistakesCalloutProps) => (
  <div className="not-prose my-14 rounded-2xl border border-neutral-300/50 bg-neutral-100/40 p-7">
      ...
      {items.map((m, i) => (
        <li key={i} className="flex items-start gap-3">
          ...
          <div className="flex-1">
            <div className="text-[15px] font-semibold text-[#000000]">{m.title}</div>

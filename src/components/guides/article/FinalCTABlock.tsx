    ...
    <div className="border-y border-slate-900/[0.06] bg-gradient-to-br from-[#F0F9FF] via-[#FAFBFC] to-[#ECFEFF] py-20 px-8">
      <div className="max-w-2xl mx-auto text-center">
        ...
        <p className="mt-4 text-[17px] text-slate-600 leading-[1.75]">
          Cogniq automatiserar kvitton, fakturor, moms och bokslut — så att du kan fokusera på företaget.
        </p>
        <div className="mt-8 flex flex-col sm:flex-row gap-3 justify-center">
          <Link
            to="/auth"
            className="inline-flex items-center justify-center gap-1.5 rounded-xl bg-white px-6 py-3 text-sm font-semibold text-[#0F172A] hover:bg-white/90 transition-all duration-200"
          >
            Testa Cogniq gratis <ArrowRight className="w-4 h-4" />
          </Link>
          <Link
            to="/contact"
            className="inline-flex items-center justify-center rounded-xl bg-white border border-slate-900/[0.08] px-6 py-3 text-sm font-semibold text-[#0F172A] hover:border-slate-900/[0.15] hover:shadow-[0_4px_12px_-4px_rgba(15,23,42,0.1)] transition-all duration-200"
          >
            Boka demo
          </Link>
        </div>
    ...
    <div className="max-w-[760px] mx-auto px-6 mt-6">
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="text-[15px] font-semibold text-[#0F172A]">Är du redovisningsbyrå?</div>

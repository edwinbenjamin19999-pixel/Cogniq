          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex gap-2">
                <Button onClick={() => setShowAgiSign(true)} className="bg-[#0052FF] text-foreground hover:bg-[#0052FF]/90">
        ...
        <TabsContent value="ku10" className="space-y-4">
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex gap-2">
                <Button onClick={() => setShowKu10Sign(true)} className="bg-[#0052FF] text-foreground hover:bg-[#0052FF]/90">
          ...
          <Card>
            ...
            <CardContent>
              ...
              <ChartGradients />
                  ...
                  <Bar dataKey="brutto" name="Bruttolön" fill="#0052FF" radius={[6, 6, 0, 0]} />
                  <Bar dataKey="arbetsgivaravgift" name="Arbetsgivaravgifter" fill="#0052FF" radius={[6, 6, 0, 0]} />
                </BarChart>
              </ResponsiveContainer>
            </CardContent>
          </Card>

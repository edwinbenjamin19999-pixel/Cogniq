...
function statusBadge(status: string, hasReceipt: boolean) {
  switch (status) {
    ...
    case "ready":
      return { label: "Klar att bokföra", className: "bg-[#EFF6FF] text-[#0052FF] border border-[#C8DDF5]" };
    case "excluded":
        ...
        <div className="min-w-0 flex-1">
          ...
          {suggestion?.debit_account && (
            <div className="flex items-center gap-2 mt-2 pl-[5.25rem] flex-wrap">
              <span className="inline-flex items-center gap-1.5 text-xs font-mono px-2 py-1 rounded-md bg-[#EFF6FF] text-[#0052FF] border border-blue-100">

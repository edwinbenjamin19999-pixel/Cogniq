...
export function TreasuryLiquidityBar({
  ...
  return (
    <div className="rounded-2xl border border-slate-100 bg-white shadow-sm border-l-[3px] border-l-[#0052FF] overflow-hidden">
      <div className="grid grid-cols-2 md:grid-cols-4 gap-px bg-slate-100">
        <Metric
          label="Banksaldo"
          value={`${fmt(bankBalance.total)} kr`}
          icon={<Wallet className="h-3.5 w-3.5 text-[#0052FF]" />}
          extra={
            <BankSyncStatus
      ...
      <div className="px-5 py-3 border-t border-slate-100 bg-white">
        ...
        <div className="flex h-1.5 w-full overflow-hidden rounded-full bg-slate-100">
          ...
          {in30 > 0 && <div className="bg-[#0052FF]" style={{ width: `${(in30 / total) * 100}%` }} />}
        ...
        <div className="flex flex-wrap gap-x-4 gap-y-1 mt-2 text-[11px] text-slate-500">
          ...
          <Legend dot="bg-[#0052FF]" label="≤ 30d" value={in30} />

      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
        {SURFACES.map((s) => (
          <button
            ...
            className="group flex items-start justify-between gap-3 p-3 rounded-xl border border-slate-200/70 bg-white hover:border-[#0052FF] hover:bg-blue-50/30 transition-colors text-left"
          >
            ...
            <ArrowUpRight className="w-3.5 h-3.5 text-slate-400 group-hover:text-[#0052FF] flex-shrink-0 mt-1" />
          </button>
        ))}
      </div>
    </BlockShell>

...
export const InventoryAICount = () => { const [mode, setMode] = useState<"schedule" | "counting" | "photo">("schedule");
        ...
        <Card>
          <CardHeader>
            <div className="flex items-center gap-2">
              <Camera className="h-5 w-5 text-[#0052FF]" />
          ...
          <CardContent className="space-y-4">
            <div className="border-2 border-dashed border-muted-foreground/20 rounded-lg p-8 text-center">
              ...
              <Button
                className="bg-[#0052FF] hover:bg-[#0052FF]/90 text-foreground"
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex gap-2 mt-3">
                        <Button size="sm" className="text-xs bg-[#0052FF] hover:bg-[#0052FF]/90 text-foreground">
  ...
  return (
    <div className="space-y-4">
      ...
      {schedule.map((s, i) => (
        <Card key={i} className={i === 0 ? "border-[#0052FF]/50 ring-1 ring-[#0052FF]/20" : ""}>
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
              ...
              {i === 0 && (
                <Button size="sm" onClick={() => setMode("counting")} className="bg-[#0052FF] hover:bg-[#0052FF]/90 text-foreground">

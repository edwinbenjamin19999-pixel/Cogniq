    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-md">
        ...
        <div className="space-y-4">
          <div className="p-3 rounded-lg bg-[#0052FF]/5 border border-[#0052FF]/20 space-y-2">
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              ...
              <Badge variant="outline" className="bg-[#0052FF]/10 text-[#0052FF] text-[10px]">
          ...
          <div className="flex justify-between gap-2">
            ...
            <Button
              ...
              className="bg-[#0052FF] hover:bg-[#0052FF]/90 text-foreground gap-1.5"
            >

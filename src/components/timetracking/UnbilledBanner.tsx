...
export function UnbilledBanner() { const { unbilled } = useUnbilledSummary();
  ...
  return (
    <>
      <div className="rounded-lg border border-[#0052FF]/30 bg-[#0052FF]/5 p-4 flex items-center justify-between gap-4">
        <p className="text-sm">
          Du har{" "}
        ...
        <Button
          size="sm"
          className="bg-[#0052FF] hover:bg-[#0052FF]/90 text-white flex-shrink-0 gap-1"

...
const SEVERITY: Record<string, { dot: string; bg: string; border: string; iconColor: string; Icon: any }> = {
  ...
  info:    { dot: "bg-[#000000]", bg: "bg-[#E6F4FA]", border: "border-[#C8DDF5]", iconColor: "text-[#000000]", Icon: Info },
};
                ...
                <div className="flex items-start gap-[10px] flex-1">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-[6px] mb-[2px]">
                      ...
                      {!n.is_read && (
                        <span className="inline-flex items-center px-[6px] h-[16px] rounded-full text-[10px] font-medium bg-[#000000] text-white">Ny</span>
                      )}
                    </div>

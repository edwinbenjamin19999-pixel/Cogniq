    ...
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <main className="flex-1 flex items-center justify-center px-4 py-32">
        <div className="max-w-lg w-full text-center space-y-6">
          {Icon && (
            <div className="mx-auto w-14 h-14 rounded-2xl bg-[#000000]/10 flex items-center justify-center">
              <Icon className="w-7 h-7 text-[#000000]" />
            </div>
          )}
          <h1 className="text-3xl sm:text-4xl font-bold text-[#000000]">{title}</h1>
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center pt-4">
            <Button asChild className="bg-white text-[#000000] hover:bg-white/90 font-semibold gap-1.5">

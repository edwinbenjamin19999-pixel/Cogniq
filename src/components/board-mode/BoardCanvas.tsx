    ...
    <div className="min-h-screen bg-gray-50 board-mode-light">
      <div className="max-w-7xl mx-auto px-6 lg:px-10 py-12 space-y-8">
        ...
        <div className="flex justify-center pt-8">
          <Link
            to="/ai-ekonom"
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full border text-xs transition-all border-gray-200 bg-white text-gray-500 hover:text-gray-800 hover:border-[#0052FF]/50"
          >

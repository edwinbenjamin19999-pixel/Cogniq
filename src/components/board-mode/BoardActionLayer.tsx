        ...
        {profile.actions.map((a, i) => (
          <button
            ...
            className={cn(
              ...
              "hover:bg-white hover:border-[#0052FF]/40 hover:-translate-y-0.5 transition-all",
              "hover:shadow-md"
            )}
          >
            ...
            <span className="inline-flex items-center gap-1 text-[#0052FF] text-xs font-medium group-hover:gap-2 transition-all">

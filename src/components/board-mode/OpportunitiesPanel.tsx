...
export const OpportunitiesPanel = ({ opportunities }: { opportunities: BoardOpportunity[] }) => (
  <div className="bg-white border border-gray-200 rounded-2xl shadow-sm p-6">
    <div className="flex items-center gap-2 mb-4">
      <Lightbulb className="h-4 w-4 text-neutral-700" />
    ...
    {opportunities.length === 0 ? (
      ...
      <div className="grid md:grid-cols-3 gap-4">
        {opportunities.map((o, i) => (
          <div key={i} className="rounded-xl bg-neutral-100 border border-neutral-100 p-5">
            ...
            <div className="text-neutral-700 text-lg font-light tabular-nums">
              +{Math.abs(o.estimated_impact).toLocaleString("sv-SE")} <span className="text-xs text-neutral-700/70">kr</span>
            </div>

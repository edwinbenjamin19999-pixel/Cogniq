  ...
  return (
    <div className="rounded-3xl border border-white/10 bg-white/5 backdrop-blur-2xl p-8">
      <div className="flex items-center gap-2 mb-2">
        ...
        <h3 className="text-xs uppercase tracking-[0.2em] text-[#000000]/80 font-medium">
          ...
          <tbody>
            {sorted.map(e => (
              <tr key={e.company_id} className="border-b border-white/5 last:border-0 hover:bg-white/[0.03]">
                ...
                <td className="py-3 text-right text-[#000000] tabular-nums">{e.revenue_share_pct.toFixed(1)}%</td>
                <td className={cn(

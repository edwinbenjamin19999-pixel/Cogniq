...
export const BoardActionsPanel = ({
  ...
  return (
    <div className="rounded-3xl border border-[#C8DDF5] bg-gradient-to-br from-[#0052FF]/[0.04] to-purple-500/[0.04] backdrop-blur-2xl p-8">
      <div className="flex items-center gap-2 mb-6">
        <Zap className="h-4 w-4 text-[#1E3A5F]" />
        <h3 className="text-xs uppercase tracking-[0.2em] text-[#0052FF]/90 font-medium">Vad ska vi göra?</h3>
      </div>
        ...
        {actions.map(a => (
          ...
          >
            ...
            <Button
              variant="ghost"
              size="sm"
              className="text-[#0052FF] hover:text-[#0052FF] hover:bg-[#EFF6FF]"

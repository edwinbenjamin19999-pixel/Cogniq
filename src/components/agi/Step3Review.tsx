...
export const Step3Review = ({ individuals, employer, reviewed, onReviewChange, period, companyName, orgNumber }: Step3Props) => {
  ...
  return (
    <div className="space-y-5">
          ...
          <CardContent className="p-0">
            <Table>
              ...
              <TableBody>
                ...
                {/* Total row */}
                <TableRow className="bg-[#000000]/5 font-bold">
                  <TableCell className="py-2.5 text-sm">Totalt</TableCell>
                  <TableCell className="py-2.5 text-right font-mono text-xs text-[#000000]">{fmt(totalGross)} kr</TableCell>
                  <TableCell className="py-2.5 text-right font-mono text-xs text-[#000000]">{fmt(totalTax)} kr</TableCell>
                  <TableCell className="py-2.5 text-right font-mono text-xs text-[#000000]">{fmt(socialFees)} kr</TableCell>
                </TableRow>
              </TableBody>
            </Table>
          </CardContent>
          ...
          <CardContent className="p-5 space-y-3">
            ...
            <div className="space-y-1">
              <div className="flex items-center justify-between">
                ...
                <span className="font-mono font-bold text-[#000000]">{fmt(sum487)} kr</span>
              </div>
              <Collapsible open={showCalc487} onOpenChange={setShowCalc487}>
                <CollapsibleTrigger className="text-xs text-[#000000] hover:underline flex items-center gap-1">
            ...
            <div className="space-y-1">
              <div className="flex items-center justify-between">
                ...
                <span className="font-mono font-bold text-[#000000]">{fmt(sum497)} kr</span>
              </div>
      ...
      {/* Total to pay card */}
      <Card className="border-2 border-[#000000]/20 bg-gradient-to-r from-[#000000]/5 to-transparent">
        <CardContent className="py-6 px-6">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <div>
              <p className="text-sm text-muted-foreground font-medium mb-1">Totalt att betala till Skatteverket</p>
              <p className="text-3xl font-bold text-[#000000] font-mono">{fmt(totalToPay)} kr</p>
            </div>
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3">
              <Badge variant="outline" className="bg-[#FAEEDA] dark:bg-neutral-700/20 text-[#7A5417] dark:text-[#C28A2B] border-[#F0DDB7] dark:border-neutral-700 gap-1.5 px-3 py-1.5">

    ...
    >
      <div className="grid md:grid-cols-2 gap-0">
        ...
        <div className="p-8 md:p-10 flex flex-col">
          ...
          <h2 className="mt-4 text-2xl md:text-3xl font-bold text-[#0F172A] tracking-tight leading-tight group-hover:text-[#0052FF] transition-colors">
            {article.title}
          </h2>
          ...
          <div className="mt-auto pt-6 flex items-center justify-between text-sm text-[#94a3b8]">
            ...
            <span className="inline-flex items-center gap-1.5 text-[#0052FF] font-medium group-hover:gap-2.5 transition-all">

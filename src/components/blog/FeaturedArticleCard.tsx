  ...
  return (
    ...
    >
      <div className="grid md:grid-cols-2 gap-0">
        <div className="relative h-64 md:h-full bg-gradient-to-br from-[#000000] via-[#000000] to-[#000000] flex items-center justify-center p-10">
          <div className="absolute inset-0 opacity-20" style={{ backgroundImage: "radial-gradient(circle at 30% 30%, rgba(0,0,0,0.6), transparent 60%)" }} />
          <div className="relative text-white/95 text-center">
            <div className="text-xs uppercase tracking-[0.2em] text-[#000000] mb-3">Featured</div>
        ...
        <div className="p-8 md:p-10 flex flex-col">
          ...
          <h2 className="mt-4 text-2xl md:text-3xl font-bold text-[#000000] tracking-tight leading-tight group-hover:text-[#000000] transition-colors">
            {article.title}
          </h2>
          ...
          <div className="mt-auto pt-6 flex items-center justify-between text-sm text-[#94a3b8]">
            ...
            <span className="inline-flex items-center gap-1.5 text-[#000000] font-medium group-hover:gap-2.5 transition-all">

    ...
    <div className="container mx-auto max-w-6xl px-6">
      <div className="text-center max-w-2xl mx-auto mb-14">
        <h2 className="text-4xl md:text-5xl font-bold text-white leading-[1.05]" style={{ letterSpacing: "-0.8px" }}>
          En plattform. <span className="text-[#000000]">Hela ekonomin.</span>
        </h2>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        {features.map((f) => (
          <div key={f.title} className="rounded-2xl border border-white/[0.06] bg-white/[0.02] p-7 hover:border-[#000000]/20 hover:bg-white/[0.03] transition-colors">
            <div className="w-11 h-11 rounded-lg bg-[#000000]/[0.08] border border-[#000000]/20 flex items-center justify-center">

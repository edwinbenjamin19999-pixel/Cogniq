...
export const AboutHero = () => (
  <section className="relative bg-[#000000] overflow-hidden">
    {/* glow orbs */}
    <div className="pointer-events-none absolute -top-32 left-1/2 -translate-x-1/2 w-[800px] h-[800px] rounded-full bg-[#000000]/10 blur-[120px]" />
    <div className="pointer-events-none absolute top-40 right-0 w-[400px] h-[400px] rounded-full bg-[#000000]/10 blur-[100px]" />
    ...
    <div className="relative container mx-auto max-w-5xl px-6 pt-32 pb-24 md:pt-40 md:pb-32 text-center">
      ...
      >
        Bokföring.{" "}
        <span className="text-[#000000]">Ombyggd från grunden.</span>
      </h1>
      <p className="mt-6 max-w-2xl mx-auto text-lg text-white/60 leading-relaxed">
        Bokfy är en AI-driven ekonomiplattform byggd för svenska bolag – där bokföring, moms och rapportering sker automatiskt, korrekt och i realtid.
      </p>
      <div className="mt-10 flex flex-col sm:flex-row gap-3 justify-center">
        <Link
          to="/auth"
          className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-lg bg-white text-[#000000] hover:bg-white/90 font-semibold text-sm transition-all"
        >

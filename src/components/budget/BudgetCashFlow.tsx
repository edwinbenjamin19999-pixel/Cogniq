          ...
          <AreaChart data={cashChartData}>
            <defs>
              <linearGradient id="cashGrad" x1="0" y1="0" x2="0" y2="1">
                <stop offset="0%" stopColor="#0040CC" stopOpacity={0.3} />
                <stop offset="100%" stopColor="#0040CC" stopOpacity={0.05} />
              </linearGradient>
            </defs>
            ...
            <Area type="monotone" dataKey="cash" fill="url(#cashGrad)" stroke="#0040CC" strokeWidth={2} name="Kassa" />
          </AreaChart>
        </ResponsiveContainer>
        {negativeMonth >= 0 && (

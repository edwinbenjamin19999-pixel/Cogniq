  ...
  return (
    <div className="max-w-3xl mx-auto mt-12 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card className="cursor-pointer hover:border-[#0052FF] hover:shadow-md transition-all" onClick={() => setMethod("ai")}>
          <CardContent className="pt-6 text-center space-y-3">
            <div className="w-12 h-12 rounded-xl bg-[#0052FF]/10 flex items-center justify-center mx-auto">

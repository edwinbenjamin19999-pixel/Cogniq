...
const SOURCE_META: Record<Source, { label: string; icon: any; cls: string }> = {
  ...
  ai:       { label: "AI",       icon: Sparkles, cls: "bg-[#EFF6FF] text-[#0052FF] border-[#C8DDF5]" },
};
                        ...
                        <td className="px-3 py-1.5 text-right">
                          {ai ? (
                            <button
                              ...
                              disabled={isLocked}
                              title={ai.reasoning}
                              className="inline-flex items-center gap-1 text-[#0052FF] hover:bg-[#EFF6FF] rounded px-1.5 py-0.5 tabular-nums"
                            >

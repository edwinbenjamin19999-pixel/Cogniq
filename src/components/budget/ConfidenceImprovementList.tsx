  ...
  return (
    <div className={cn("space-y-2", className)}>
      {suggestions.map((s) => (
        <div
          key={s.id}
          className="flex items-start gap-3 p-3 rounded-lg border border-slate-200 bg-white hover:border-[#0052FF] transition-colors"
        >
          ...
          <Button
            size="sm"
            variant="ghost"
            className="h-7 px-2 text-xs gap-1 text-[#0052FF] hover:text-[#0052FF] hover:bg-[#EFF6FF]"
            onClick={() => {

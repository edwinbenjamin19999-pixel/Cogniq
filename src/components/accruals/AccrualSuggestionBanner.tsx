      ...
      <div className="p-3 rounded-[10px] border-[0.5px] border-[#C8DDF5] bg-[#EFF6FF] flex items-start gap-3">
        ...
        <div className="flex-1">
          ...
          <div className="flex gap-2 mt-2">
            <Button size="sm" onClick={() => setOpen(true)} className="h-[28px] bg-[#0052FF] hover:bg-[#0052FF] text-white">
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="max-w-lg">
          ...
          <DialogFooter>
            ...
            <Button onClick={handleConfirm} disabled={saving} className="bg-[#0052FF] hover:bg-[#0052FF]">

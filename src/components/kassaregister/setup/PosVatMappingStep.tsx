  ...
  return (
    <div className="space-y-5 animate-fade-in">
      <Card className="border-l-[3px] border-l-[#0052FF]">
        <CardHeader>
          <div className="flex items-center justify-between gap-3">
            ...
            <span className="inline-flex items-center gap-1 text-xs font-medium px-2 py-1 rounded-full bg-[#EFF6FF] text-[#0052FF] border border-[#C8DDF5]">
      ...
      <div className="flex justify-between gap-2">
        ...
        <Button onClick={onNext} className="bg-[#0052FF] hover:bg-[#0052FF] text-white gap-1.5">

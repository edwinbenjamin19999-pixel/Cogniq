  ...
  return (
    <div className="space-y-4 mt-4">
      <div className="flex items-center justify-between gap-3">
        ...
        <Button onClick={() => setShowAdd(true)} className="gap-1.5 bg-[#0052FF] hover:bg-[#0052FF]/90 text-white">
        ...
        <DialogContent className="max-w-sm">
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-end gap-2 pt-2">
              ...
              <Button onClick={handleAdd} disabled={addReport.isPending || !totalSales} className="bg-[#0052FF] hover:bg-[#0052FF]/90 text-white">

  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 mb-2">
        <div className="w-6 h-6 rounded-md bg-[#000000] text-white flex items-center justify-center">
      ...
      <div className="space-y-2">
        {suggestions.map(s => (
          <div key={s.id} className="flex items-center justify-between gap-3 py-1">
            ...
            <button
              onClick={s.onClick}
              className="shrink-0 text-[12px] bg-[#000000] hover:bg-[#08374b] text-white px-3 py-1.5 rounded-md flex items-center gap-1 transition-colors"
            >

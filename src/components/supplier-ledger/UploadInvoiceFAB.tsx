  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-6 right-6 z-40 h-14 w-14 rounded-full bg-[#0F1F3D] text-white shadow-[0_8px_24px_rgba(0,0,0,0.4)] hover:shadow-[0_12px_32px_rgba(0,0,0,0.5)] hover:scale-105 transition-all flex items-center justify-center group"
        ...
        <SheetContent className="sm:max-w-md">
          ...
          <div
            className={`mt-6 rounded-2xl border-2 border-dashed transition-all duration-200 p-10 text-center cursor-pointer
              ${dragOver ? "border-[#000000]/70 bg-[#EFF6FF]" : "border-slate-200 bg-slate-50/40 hover:border-[#000000]/50 hover:bg-neutral-100/40"}`}
          ...
          >
            <Upload className="h-10 w-10 mx-auto mb-3 text-[#000000]" />

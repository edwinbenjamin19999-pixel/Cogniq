...
const TONE_STYLES = {
  info: { bg: "from-blue-50 to-blue-50/30 dark:from-blue-950/30 dark:to-transparent", border: "border-[#C8DDF5] dark:border-[#0052FF]/50", icon: "text-[#1E3A5F] dark:text-[#1E3A5F]", iconBg: "bg-[#EFF6FF] dark:bg-blue-950/50" },

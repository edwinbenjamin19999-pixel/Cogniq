...
const BUCKETS = [
  { key: "critical" as const, label: "Kritiska", color: "bg-[#C73838]", text: "text-[#C73838] dark:text-[#C73838]", border: "border-[#F4C8C8] dark:border-neutral-700/50", bg: "bg-[#FCE8E8]/50 dark:bg-rose-950/20" },
  ...
  { key: "medium" as const, label: "Medel", color: "bg-[#C28A2B]", text: "text-[#7A5417] dark:text-[#C28A2B]", border: "border-[#F0DDB7] dark:border-neutral-700/50", bg: "bg-[#FAEEDA]/50 dark:bg-amber-950/20" },
  { key: "info" as const, label: "Info", color: "bg-[#1D9E75]", text: "text-[#1D9E75] dark:text-[#1D9E75]", border: "border-[#BFE6D6] dark:border-neutral-700/50", bg: "bg-[#E1F5EE]/50 dark:bg-emerald-950/20" },
];
        ...
        return (
          <button
            ...
            className={cn(
              ...
              b.border, b.bg,
              isActive ? "ring-2 ring-offset-1 ring-[#000000] scale-[1.02]" : "hover:scale-[1.02]"
            )}
          >

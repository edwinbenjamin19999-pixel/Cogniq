...
export const EarlyBirdCTA = () => {
  return (
    <section id="pricing" className="relative py-24 sm:py-32 overflow-hidden bg-gradient-to-b from-[#0a1428] via-[#0F172A] to-[#0a1428]">
      <div
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[500px] rounded-full bg-[radial-gradient(ellipse_at_center,rgba(0,82,255,0.1)_0%,transparent_70%)] animate-pulse pointer-events-none" style={{ animationDuration: "4s" }} />

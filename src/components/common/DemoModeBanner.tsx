...
export const DemoModeBanner = ({ title, description, contact = "support@bokfy.se" }: DemoModeBannerProps) => {
  return (
    <div className="rounded-lg border-2 border-neutral-700 bg-[#FAEEDA] dark:bg-amber-950/30 px-4 py-3">
      <div className="flex items-start gap-3">
        <AlertTriangle className="h-5 w-5 text-[#7A5417] dark:text-[#C28A2B] shrink-0 mt-0.5" />
        <div className="flex-1">
          <p className="text-sm font-semibold text-[#7A5417] dark:text-neutral-300">
            {title}
          </p>

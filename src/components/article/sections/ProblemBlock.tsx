...
export const ProblemBlock = ({ data }: { data: ProblemBlockData }) => (
  <section className="my-14">
    ...
    <div className="relative rounded-2xl border border-slate-900/[0.06] bg-[#F1F5F9] p-7">
      <div className="absolute -top-3 left-7 inline-flex h-8 w-8 items-center justify-center rounded-full bg-neutral-100 border border-neutral-300/60 shadow-[0_1px_2px_rgba(15,23,42,0.04)]">

  ...
  return (
    <aside className="h-full overflow-y-auto bg-slate-50 dark:bg-slate-950/30 border-r border-slate-200 dark:border-slate-800 p-3">
      <button
        ...
        className="w-full mb-3 rounded-lg bg-[#0052FF] hover:bg-[#0052FF] text-white text-sm font-medium px-3 py-2 transition-colors"
      >
        + Ny dialog
      </button>
              ...
              <li key={c.id}>
                <button
                  ...
                  className={cn(
                    ...
                    activeId === c.id && "bg-[#EFF6FF] text-[#0052FF] dark:text-[#0052FF] font-medium",
                  )}
                >

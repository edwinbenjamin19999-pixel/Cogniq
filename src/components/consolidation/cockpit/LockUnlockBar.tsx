  ...
  return (
    <div className={cn(
      ...
      <div className="flex items-center gap-3">
        {isLocked ? (
          ...
          <>
            ...
            <div>
              <p className="text-sm font-medium text-[#0052FF] flex items-center gap-2">
                Redigeringsläge aktivt
                <span className="px-2 py-0.5 rounded-md bg-[#EFF6FF] text-[#0052FF] text-[10px] font-semibold uppercase tracking-wider">
                  Manual Adjustment
                </span>
              </p>
              <p className="text-xs text-[#0052FF]/80">Manuella ändringar går till adjustment-lagret — bolagens grundbokföring rörs aldrig.</p>
            </div>
          </>
        )}
      </div>
      <Button
        ...
        size="sm"
        onClick={onToggle}
        className={isLocked ? 'bg-[#0052FF] hover:bg-[#0052FF] text-white' : ''}
      >

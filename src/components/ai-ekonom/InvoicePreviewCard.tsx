...
export const InvoicePreviewCard = ({ data, companyId }: Props) => {
  ...
  return (
    <div className="mt-3 rounded-2xl border border-[#C8DDF5] bg-gradient-to-br from-[#0052FF]/5 via-card to-card shadow-sm overflow-hidden">
      {/* Header */}
      <div className="px-4 py-3 border-b border-border/40 bg-[#EFF6FF] flex items-center justify-between gap-3">
        <div className="flex items-center gap-2.5 min-w-0">
          <div className="w-8 h-8 rounded-lg bg-[#EFF6FF] flex items-center justify-center shrink-0">
            <FileText className="w-4 h-4 text-[#0052FF] dark:text-[#1E3A5F]" />
          </div>
        ...
        <div className="flex items-center justify-between gap-3 flex-wrap">
          ...
          {data.customer_was_created && data.customer.id && (
            <button
              ...
              className="text-[11px] flex items-center gap-1 text-[#0052FF] dark:text-[#1E3A5F] hover:underline"
            >
      ...
      <div className="px-4 py-3 flex flex-wrap gap-2">
        <Button
          ...
          className="bg-[#0052FF] hover:bg-[#0052FF] text-white"
        >
          {status === "sending" ? (

...
export const DailyAISection = () => {
  ...
  return (
    <section ref={sectionRef} className="py-20 sm:py-28 bg-gradient-to-b from-[#000000] to-[#0B1D2A]">
      <div className="container mx-auto px-4 sm:px-6 max-w-3xl">
          ...
          {steps.map((step, i) => (
            <div
              ...
              className={`flex items-center gap-2.5 px-4 py-3 rounded-xl border transition-all duration-500 ${
                i < visibleSteps
                  ? "border-[rgba(0,0,0,0.2)] bg-[rgba(0,0,0,0.06)] opacity-100 translate-y-0"
                  : "border-white/[0.06] bg-white/[0.02] opacity-30 translate-y-2"
              }`}
            >
              <Check
                className={`w-4 h-4 flex-shrink-0 transition-colors duration-300 ${
                  i < visibleSteps ? "text-neutral-700" : "text-white/20"
                }`}
              />
        ...
        <div className="sm:hidden -mx-4 mb-6">
          <div className="flex gap-3 overflow-x-auto snap-x snap-mandatory px-4 pb-3 scrollbar-hide">
            <div className="snap-center flex-shrink-0 w-[88%] rounded-xl border border-[rgba(0,0,0,0.25)] bg-[rgba(0,0,0,0.06)] p-5">
              <div className="flex items-center gap-2 mb-2">
                <Lightbulb className="w-4 h-4 text-[#000000]" />
                <span className="text-[12px] font-semibold text-[#000000] uppercase tracking-wider">Insikt</span>
              </div>
              ...
              <button className="mt-3 text-[13px] font-semibold text-[#000000]">Se varför →</button>
            </div>
            <div className="snap-center flex-shrink-0 w-[88%] rounded-xl border border-neutral-700/25 bg-neutral-700/[0.06] p-5">
              <div className="flex items-center gap-2 mb-2">
                <AlertTriangle className="w-4 h-4 text-neutral-700" />
                <span className="text-[12px] font-semibold text-neutral-700 uppercase tracking-wider">Varning</span>
              </div>
              <p className="text-[15px] text-white/85 leading-relaxed">
        ...
        >
          <div className="rounded-xl border border-[rgba(0,0,0,0.25)] bg-[rgba(0,0,0,0.06)] p-5">
            <div className="flex items-center gap-2 mb-2">
              <Lightbulb className="w-4 h-4 text-[#000000]" />
              <span className="text-[12px] font-semibold text-[#000000] uppercase tracking-wider">Insikt</span>
            </div>
            ...
            <button className="mt-3 text-[13px] font-semibold text-[#000000] hover:text-[#000000] transition-colors">
              Se varför →
            </button>
          </div>

          <div className="rounded-xl border border-neutral-700/25 bg-neutral-700/[0.06] p-5">
            <div className="flex items-center gap-2 mb-2">
              <AlertTriangle className="w-4 h-4 text-neutral-700" />
              <span className="text-[12px] font-semibold text-neutral-700 uppercase tracking-wider">Varning</span>
            </div>
        ...
        >
          <span className="text-[13px] text-[#000000] font-medium">AI analyserar varje transaktion</span>
          <span className="text-[13px] text-white/20">·</span>
          <span className="text-[13px] text-neutral-700/70 font-medium">Bokför automatiskt vid hög säkerhet</span>
          <span className="text-[13px] text-white/20">·</span>
          <span className="text-[13px] text-neutral-700/70 font-medium">Flaggar avvikelser för granskning</span>
        </div>

...
export const DailyAISection = () => {
  ...
  return (
    <section ref={sectionRef} className="py-20 sm:py-28 bg-gradient-to-b from-[#0F172A] to-[#0B1D2A]">
          ...
          {steps.map((step, i) => (
            <div
              ...
              className={`flex items-center gap-2.5 px-4 py-3 rounded-xl border transition-all duration-500 ${
                i < visibleSteps
                  ? "border-[rgba(0,82,255,0.2)] bg-[rgba(0,82,255,0.06)] opacity-100 translate-y-0"

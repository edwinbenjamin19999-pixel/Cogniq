        ...
        <div className="space-y-4">
          ...
          {(phase === "signing-1" || phase === "signing-2") && (
            <div className="text-center py-6 space-y-3">
              <Loader2 className="h-10 w-10 mx-auto animate-spin text-[#0052FF]" />
  ...
  return (
    <button
      ...
      className={`rounded-xl border p-3 text-left transition-colors ${
        active
          ? "border-[#0052FF] bg-[#EFF6FF] ring-2 ring-[#0052FF]/20"
          : "border-border bg-card hover:bg-muted/40"
      }`}
    >
      <Icon className={`h-4 w-4 mb-1 ${active ? "text-[#0052FF]" : "text-muted-foreground"}`} />

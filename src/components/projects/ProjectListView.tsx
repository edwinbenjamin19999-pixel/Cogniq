      ...
      <CardContent className="p-5 space-y-3">
        ...
        {insight && (
          <div className="flex items-center gap-1.5 text-[10px] text-muted-foreground bg-muted/50 rounded px-2 py-1">
            <Sparkles className="h-3 w-3 text-[#0052FF] flex-shrink-0" />
            {insight}
          </div>
        )}
      </CardContent>
    ...
    <Card className="border-l-4 border-l-[#0052FF] bg-[#0052FF]/5">
      <CardContent className="py-4 px-5">
        <div className="flex items-start gap-3">
          <Sparkles className="h-5 w-5 text-[#0052FF] flex-shrink-0 mt-0.5" />
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold flex items-center gap-2">
            <FolderKanban className="h-6 w-6 text-[#0052FF]" />
            Projektredovisning
          </h1>
        ...
        <Button onClick={onNew} className="bg-[#0052FF] hover:bg-[#0052FF]/90 text-white">
      ...
      {isLoading ? (
        ...
        <Card>
          <CardContent className="p-12 text-center">
            ...
            <Button onClick={onNew} className="mt-4 bg-[#0052FF] hover:bg-[#0052FF]/90 text-white">
              <Plus className="h-4 w-4 mr-1" />
              Skapa projekt
            </Button>
          </CardContent>

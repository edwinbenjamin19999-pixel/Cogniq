        ...
        <div className="mt-6 space-y-6">
          ...
          <section className="space-y-2">
            ...
            <div className="space-y-1.5 text-sm">
              {customer.email && (
                <a href={`mailto:${customer.email}`} className="flex items-center gap-2 text-slate-700 hover:text-[#0052FF]">
                  <Mail className="h-4 w-4 text-slate-400" />{customer.email}
                </a>
              )}
              {customer.phone && (
                <a href={`tel:${customer.phone}`} className="flex items-center gap-2 text-slate-700 hover:text-[#0052FF]">
          ...
          {/* AI insight */}
          {profile && (
            <section className="rounded-2xl border border-slate-200/70 border-l-[3px] border-l-[#0052FF] bg-white p-4 shadow-[0_1px_3px_rgba(15,23,42,0.04)]">
              <div className="flex items-start gap-2">
                <Brain className="h-4 w-4 text-[#0052FF] mt-0.5 flex-shrink-0" />
          ...
          <section className="space-y-2">
            <Button
              className="w-full bg-[#0052FF] hover:bg-[#0052FF] text-white"
              onClick={() => {
                onOpenChange(false);

    ...
    <div className="px-4 pt-4 pb-6 space-y-5 bg-[#F8FAFB] min-h-full">
      ...
      <section className="bg-white border-[0.5px] border-[#E2E8F0] rounded-2xl p-4 shadow-[0_1px_2px_rgba(15,23,42,0.04)]">
        <div className="flex items-center gap-2 mb-1">
          <Sparkles size={18} color="#0052FF" strokeWidth={1.75} />
          ...
          {loadingTopSection
            ...
            : bullets.map((b) => (
                <li key={b.id}>
                  ...
                  >
                    <span className="w-1.5 h-1.5 rounded-full bg-[#0052FF] mt-[10px] flex-shrink-0" />
          ...
          <div className="space-y-2">
              ...
              : attention.slice(0, 3).map((a) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <button
                        onClick={a.onAction}
                        className="w-full h-[44px] rounded-xl bg-[#0052FF] active:bg-[#0052FF] text-white text-[15px] font-medium transition-colors"
                      >
                        {a.actionLabel}
                      </button>
                    </div>
            ...
            {moreAttention && (
              <button
                ...
                className="w-full text-[13px] text-[#0052FF] font-medium py-2 active:opacity-60"
              >
          ...
          <div className="px-5 pb-6">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-10 h-10 rounded-xl bg-[#EFF6FF] flex items-center justify-center">
                <openSheet.icon size={20} color="#0052FF" strokeWidth={1.75} />
              </div>
            ...
            <button
              ...
              className="mt-6 w-full h-[48px] rounded-xl bg-[#0052FF] active:bg-[#0052FF] text-white text-[15px] font-medium"
            >
              Öppna detaljvy
            </button>
          </div>

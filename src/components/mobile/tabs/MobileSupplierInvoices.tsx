        ...
        <div className="flex flex-col h-full">
          ...
          <div className="px-5 pb-4 border-b-[0.5px] border-[#E2E8F0]">
            ...
            <button
              ...
              className="mt-3 inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-[#0052FF]/10 border border-[#0052FF]/20 text-[#0052FF] text-[13px] font-medium active:bg-[#0052FF]/15"
            >
                ...
                <div className="space-y-1.5 pt-1">
                  {proposedLines.map((l, i) => (
                    <div key={i} className="flex items-center justify-between py-1.5 px-3 bg-[#F8FAFB] rounded-lg">
                      ...
                      <span className={cn("text-[13px] tabular-nums font-medium", l.amount < 0 ? "text-[#0052FF]" : "text-[#1D9E75]")}>
            ...
            {invoice.document_id && (
              ...
              >
                <div className="w-10 h-10 rounded-xl bg-[#EFF6FF] flex items-center justify-center">
                  <FileText size={18} color="#0052FF" strokeWidth={1.75} />
                </div>
          ...
          >
            <button
              ...
              className="w-full h-[52px] rounded-xl bg-[#0052FF] active:bg-[#0052FF] text-white text-[15px] font-medium"
            >
              Attestera & bokför
            </button>
      ...
      <div className="flex items-center gap-2 px-3 py-2 border-b-[0.5px] border-[#E2E8F0]">
        ...
        <div className="flex-1 relative">
          ...
          <input
            ...
            className="w-full h-11 pl-9 pr-3 bg-[#F8FAFB] border-[0.5px] border-[#E2E8F0] rounded-xl text-[15px] text-[#0F172A] focus:outline-none focus:border-[#0052FF]"
          />
        </div>
      </div>
...
const AccountResultRow = ({ a, onSelect }: { a: { number: string; name: string }; onSelect: (a: { number: string; name: string }) => void }) => (
  ...
  >
    <span className="font-mono text-[14px] text-[#0052FF] w-12 text-left">{a.number}</span>

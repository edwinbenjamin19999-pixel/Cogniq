        ...
        <div>
          ...
          <div className="mx-5 mt-4 bg-white rounded-[20px] border border-slate-100 shadow-sm overflow-hidden">
            <div className="flex flex-col items-center py-8 px-5">
              <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#0052FF] to-blue-500 flex items-center justify-center shadow-lg shadow-[#0052FF]/20 mb-4">
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="mt-auto pt-1">
                        {stuck && isRetrying ? (
                          <span className="text-[11px] font-semibold text-[#0052FF] bg-blue-50 px-2.5 py-1 rounded-full flex items-center gap-1 w-fit">

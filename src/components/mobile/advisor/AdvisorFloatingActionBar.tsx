...
const TONES = {
  emerald: "text-neutral-300 hover:bg-neutral-700/15",
  cyan: "text-[#000000] hover:bg-[#000000]/15",
  amber: "text-neutral-300 hover:bg-neutral-700/15",
  violet: "text-neutral-300 hover:bg-neutral-700/15",
} as const;

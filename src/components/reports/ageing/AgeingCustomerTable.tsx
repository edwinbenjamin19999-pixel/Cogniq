                              ...
                              <div className="flex items-center gap-2">
                                ...
                                {canRemind && companyId && (
                                  <button
                                    ...
                                    className="inline-flex items-center gap-1 text-[11px] h-6 px-2 rounded-md border border-[#C8DDF5] dark:border-[#0052FF]/60 text-[#0052FF] dark:text-[#1E3A5F] hover:bg-[#EFF6FF] dark:hover:bg-blue-950/30 transition-colors"
                                  >

...
const variantRowClassComfortable: Record<FinancialRowData["variant"], string> = {
  section:
    "h-14 bg-slate-50/60 dark:bg-slate-800/50 border-l-2 border-[#0052FF] border-b border-slate-200/60 dark:border-slate-700 font-semibold text-slate-900 dark:text-slate-100",
  subcategory:
          ...
          if (isFirst) {
            return (
              ...
              >
                <span
                  className={cn(
                    "report-numeric text-[#0052FF] dark:text-[#1E3A5F] font-semibold text-[12px]",

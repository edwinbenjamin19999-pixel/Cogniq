...
export function AIExplanationBlock({ cacheKey, payload, fallback }: AIExplanationBlockProps) {
  ...
  return (
    <div className="rounded-xl border border-blue-200/50 bg-gradient-to-br from-blue-50/40 to-transparent p-4 dark:border-[#0052FF]/40 dark:from-blue-900/10">
      <div className="mb-2 flex items-center justify-between">
        <div className="flex items-center gap-1.5 text-xs font-semibold uppercase tracking-wide text-[#0052FF] dark:text-[#1E3A5F]">

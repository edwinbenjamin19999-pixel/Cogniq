  ...
  return (
    <div className="space-y-4">
      ...
      <button
        ...
        className="w-full rounded-xl border border-border bg-card px-4 py-3 text-left text-sm font-medium text-foreground transition-colors hover:border-[#0052FF] hover:bg-blue-50/40 dark:hover:bg-blue-900/10"
      >

...
export function GlobalActionBar({ insights, pending, onFixAllCritical, onImproveLiquidity, onSendAllReminders }: Props) {
  ...
  return (
    <div className="rounded-2xl border border-slate-200/60 dark:border-white/10 bg-gradient-to-br from-white via-blue-50/30 to-white dark:from-white/[0.04] dark:via-[#0052FF]/[0.04] dark:to-white/[0.04] backdrop-blur-xl p-3 shadow-sm">
      <div className="flex items-center gap-2 flex-wrap">
        ...
        {pending && <Loader2 className="h-3.5 w-3.5 animate-spin text-[#0052FF] dark:text-[#1E3A5F]" />}
      </div>
    </div>
  );
}
    ...
    <button
      ...
      className={cn(
        ...
        tone === "critical"
          ...
          : "bg-[#EFF6FF] dark:bg-[#EFF6FF] border-[#C8DDF5] dark:border-[#C8DDF5] text-[#0052FF] dark:text-[#0052FF] hover:bg-[#EFF6FF] dark:hover:bg-[#EFF6FF]",

...
export function TrustPanel({ companyId, actionType }: Props) {
  ...
  return (
    <div className="rounded-xl border border-[#C8DDF5] dark:border-[#C8DDF5] bg-blue-50/60 dark:bg-[#0052FF]/[0.06] p-3">
      <div className="flex items-center gap-2 mb-2">
        <Shield className="h-4 w-4 text-[#0052FF] dark:text-[#1E3A5F]" />
        <h4 className="text-xs font-semibold uppercase tracking-wide text-[#0052FF] dark:text-[#0052FF]">AI-historik (30 dagar)</h4>
      </div>
      ...
      {stats.pattern && stats.pattern.total >= 3 && (
        <div className="mt-2 pt-2 border-t border-blue-200/60 dark:border-[#C8DDF5] flex items-center gap-1.5 text-[11px] text-[#0052FF] dark:text-[#0052FF]">

...
export const CenteredHero = () => {
  ...
  return (
    <section className="relative min-h-[100dvh] flex flex-col items-center justify-center overflow-hidden bg-[#0B1D2A] pt-[60px] pb-16">
      <div className="absolute top-[20%] left-1/2 -translate-x-1/2 w-[800px] h-[600px] rounded-full bg-[radial-gradient(ellipse_at_center,rgba(0,0,0,0.12)_0%,transparent_70%)] pointer-events-none" />

      <div className="relative z-10 w-full max-w-[720px] mx-auto px-4 sm:px-6 text-center">
        <div className="inline-flex items-center gap-2 mb-6 border border-[rgba(0,0,0,0.25)] rounded-full px-4 py-1.5 bg-[rgba(0,0,0,0.06)]">
        ...
        <p className="hidden sm:block text-[16px] text-white/80 mb-3 max-w-[560px] mx-auto leading-relaxed">
          Spara <span className="text-[#000000] font-semibold tabular-nums">10–20 timmar</span> per månad — utan manuellt arbete
        </p>
        ...
        <form onSubmit={handleSubmit} className="space-y-3 max-w-[420px] mx-auto mb-4">
          <div className="hidden sm:grid grid-cols-2 gap-3">
            <Input
              ...
              className="h-11 bg-white/[0.07] border-white/[0.12] text-white placeholder:text-white/30 focus:border-[rgba(0,0,0,0.5)] focus-visible:ring-0 rounded-lg"
            />
            <Input
              type="text"
              placeholder="Företag"
          ...
          <Input
            ...
            className="h-13 sm:h-11 bg-white/[0.07] border-white/[0.12] text-white placeholder:text-white/30 focus:border-[rgba(0,0,0,0.5)] focus-visible:ring-0 rounded-lg"
          />
          <Button
            type="submit"
            disabled={loading}
            className="w-full h-13 sm:h-12 text-[15px] font-semibold bg-gradient-to-r from-[#000000] to-[#000000] text-white hover:brightness-110 rounded-lg shadow-[0_4px_24px_rgba(0,0,0,0.4)] transition-all duration-200 hover:scale-[1.02]"
          >
        ...
        <div className="hidden sm:block relative max-w-[520px] mx-auto mt-6">
          <div className="absolute -inset-3 rounded-2xl bg-[radial-gradient(ellipse_at_center,rgba(0,0,0,0.1)_0%,transparent_70%)] blur-xl pointer-events-none" />
          <div className="relative rounded-2xl border border-white/10 bg-white/[0.04] backdrop-blur-xl overflow-hidden shadow-[0_8px_40px_rgba(0,0,0,0.3)]">
            <div className="flex items-center gap-2 px-4 py-2.5 border-b border-white/[0.06]">
              ...
              <span className="ml-auto w-2 h-2 rounded-full bg-neutral-700 animate-pulse" />
            </div>
            ...
            <div className="p-5 space-y-3 min-h-[200px]">
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="bg-white/[0.06] border border-white/[0.08] rounded-lg px-3 py-2 flex-1">
                  <p className="text-[13px] text-white/80 font-mono">
                    ...
                    {demoPhase === "typing" && (
                      <span className="inline-block w-[2px] h-[14px] bg-[#000000] ml-0.5 align-middle animate-pulse" />
                    )}
                  </p>
                </div>
              </div>
              ...
              {(demoPhase === "processing" || demoPhase === "responding" || demoPhase === "done") && (
                <div className="flex items-start gap-2">
                  <span className="text-[11px] text-[#000000] font-medium w-8 mt-1">AI:</span>
                    ...
                    {processingSteps.map((step, i) => (
                      ...
                      >
                        {demoPhase === "processing" && i === visibleProcessing - 1 ? (
                          <Loader2 className="w-3.5 h-3.5 text-[#000000] flex-shrink-0 animate-spin" />
                        ) : (

...
export const CenteredHero = () => {
  ...
  return (
    <section className="relative min-h-[100dvh] flex flex-col items-center justify-center overflow-hidden bg-[#0B1D2A] pt-[60px] pb-16">
      <div className="absolute top-[20%] left-1/2 -translate-x-1/2 w-[800px] h-[600px] rounded-full bg-[radial-gradient(ellipse_at_center,rgba(0,82,255,0.12)_0%,transparent_70%)] pointer-events-none" />
      ...
      <div className="relative z-10 w-full max-w-[720px] mx-auto px-4 sm:px-6 text-center">
        ...
        <p className="hidden sm:block text-[17px] text-white/70 mb-3 leading-relaxed max-w-[600px] mx-auto">
          Cogniq analyserar, bokför, stämmer av och förbereder deklarationer automatiskt. Du driver bolaget — AI gör jobbet.
        </p>
        ...
        <form onSubmit={handleSubmit} className="space-y-3 max-w-[420px] mx-auto mb-4">
          <div className="hidden sm:grid grid-cols-2 gap-3">
            <Input
              ...
              className="h-11 bg-white/[0.07] border-white/[0.12] text-white placeholder:text-white/30 focus:border-[rgba(0,82,255,0.5)] focus-visible:ring-0 rounded-lg"
            />
            <Input
              type="text"
              placeholder="Företag"
          ...
          <Input
            ...
            className="h-13 sm:h-11 bg-white/[0.07] border-white/[0.12] text-white placeholder:text-white/30 focus:border-[rgba(0,82,255,0.5)] focus-visible:ring-0 rounded-lg"
          />
          <Button
            type="submit"
            disabled={loading}
        ...
        <div className="hidden sm:block relative max-w-[520px] mx-auto mt-6">
          <div className="absolute -inset-3 rounded-2xl bg-[radial-gradient(ellipse_at_center,rgba(0,82,255,0.1)_0%,transparent_70%)] blur-xl pointer-events-none" />
          <div className="relative rounded-2xl border border-white/10 bg-white/[0.04] backdrop-blur-xl overflow-hidden shadow-[0_8px_40px_rgba(0,0,0,0.3)]">
            <div className="flex items-center gap-2 px-4 py-2.5 border-b border-white/[0.06]">
              ...
              <span className="text-[11px] text-white/30 ml-2 font-medium">Cogniq</span>

    ...
    <div className="min-h-screen bg-white">
          ...
          <div className="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3">
            {FEATURES.map(({ icon: Icon, title, body }) => (
              ...
              >
                ...
                <h3 className="mt-5 text-base font-bold text-[#0F1B2D]">{title}</h3>
                <p className="mt-2 text-sm leading-relaxed text-[#0F1B2D]/60">{body}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="relative overflow-hidden bg-[#F59E0B] py-20">
        ...
        <div className="relative mx-auto max-w-2xl px-6 text-center">
          <h2 className="text-3xl md:text-4xl font-extrabold tracking-tight text-[#0F1B2D]">
            Redo att sluta bokföra manuellt?
          </h2>
          <p className="mt-3 text-base text-[#0F1B2D]/80">

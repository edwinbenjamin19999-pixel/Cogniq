                ...
                return (
                  ...
                  >
                    ...
                    <Link
                      ...
                      className="text-xs font-medium text-slate-700 hover:text-[#0052FF] truncate"
                    >
                      {item.agentName}
                    </Link>
                    <div className="flex justify-end gap-2">
                      {auto ? (
                        ...
                        <>
                          ...
                          <Button
                            size="sm"
                            className="h-8 px-3 bg-[#0052FF] hover:bg-[#1D4FD8] text-white"

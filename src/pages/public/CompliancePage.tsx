...
const SECTIONS = [
  { icon: BookCheck, title: "BAS-kontoplan 2026", desc: "Cogniq följer den senaste BAS-kontoplanen med automatisk uppdatering vid årsskifte. Alla konton, momskoder och SRU-kopplingar är förkonfigurerade." },
    ...
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <main className="flex-1">
        <section className="pt-32 pb-12 bg-gradient-to-b from-slate-50 to-white">
          <div className="container mx-auto max-w-3xl px-6 text-center">
            ...
            <p className="mt-5 text-lg text-[#475569] leading-relaxed">
              Cogniq följer svensk redovisningsstandard, dataskyddsregler och inlämningskrav — så att du kan fokusera på företaget istället för paragraferna.
            </p>
          </div>
        </section>
        ...
        <section className="py-16">
          <div className="container mx-auto max-w-3xl px-6 text-center">
            <h2 className="text-3xl font-bold text-[#0F172A]">Trygghet inbyggd från dag ett</h2>

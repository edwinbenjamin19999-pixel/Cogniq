...
export default function AccountingGuidesIndexPage() {
  ...
  const indexJsonLd = {
    ...
    url: "https://bokfy.se/resources/accounting-guides",
    inLanguage: "sv-SE",
    hasPart: allCards.map((c) => ({
      "@type": "Article",
      headline: c.title,
      url: `https://bokfy.se/resources/accounting-guides/${c.slug}`,
    })),
  };
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      <ArticleSEO
        title="Bokföringsguider — komplett guide-bibliotek på svenska | Bokfy"
      ...
      <main className="flex-1">
              ...
              return (
                <div key={cluster.id} id={cluster.id} className="scroll-mt-24">
                  <div className="mb-6 pb-4 border-b border-slate-100">
                    <h2 className="text-2xl md:text-[28px] font-bold text-[#000000] tracking-tight">
                      {cluster.label}
                    </h2>
                  ...
                  <div className="mt-4 inline-flex items-center gap-1.5 text-xs italic text-[#000000]">
                    <Sparkles className="w-3 h-3" />
                    Alla dessa moment hanteras automatiskt av Bokfy
                  </div>
                </div>
              );
            })}
        ...
        <section className="py-16">
          <div className="container mx-auto max-w-4xl px-6">
            <div className="rounded-3xl bg-gradient-to-br from-blue-50 via-white to-slate-50 border border-black/60 shadow-[0_8px_32px_-12px_rgba(0,0,0,0.18)] p-10 md:p-14 text-center">
              <div className="inline-flex h-12 w-12 items-center justify-center rounded-2xl bg-[#000000] text-white mb-5">
              ...
              <p className="mt-4 text-lg text-[#475569] leading-relaxed max-w-xl mx-auto">
                Bokfy bokför kvitton, fakturor och moms automatiskt med AI.
              </p>
              <div className="mt-7 flex flex-col sm:flex-row gap-3 justify-center">
                <Button asChild size="lg" className="bg-[#000000] text-white hover:bg-[#000000] gap-1.5">
                  <Link to="/auth">
                ...
                <Button
                  ...
                  size="lg"
                  variant="outline"
                  className="border-slate-300 text-[#000000] hover:bg-slate-50"
                >
        ...
        <section className="pb-16">
          <div className="container mx-auto max-w-4xl px-6">
            <div className="rounded-2xl bg-gradient-to-br from-[#000000] to-[#000000] p-8 md:p-10 text-white">
              <div className="flex items-center gap-2 text-xs font-medium uppercase tracking-wider text-[#000000]">
              ...
              <div className="mt-6 flex flex-col sm:flex-row gap-3">
                <Button asChild className="bg-[#000000] text-white hover:bg-[#000000] gap-1.5">
                  <Link to="/white-label">

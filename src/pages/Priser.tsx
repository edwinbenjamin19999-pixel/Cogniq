  ...
  <div className="flex items-start gap-3 py-2">
    <span
      className={`mt-0.5 flex h-5 w-5 flex-shrink-0 items-center justify-center rounded-md ${
        onBlue ? "bg-[#000000]" : "bg-white"
      }`}
    >
      <Check
        className={`h-3 w-3 ${onBlue ? "text-white" : "text-[#000000]"}`}
        strokeWidth={3}
        aria-hidden
      />
    </span>
    <span className="text-[14px] leading-6 text-[#000000]/75">{text}</span>
  </div>
);
      ...
      <main>
        ...
        <section className="bg-white py-24">
          <div className="mx-auto grid max-w-4xl grid-cols-1 items-start gap-6 px-6 md:grid-cols-2">
            ...
            <div className="relative rounded-lg border-2 border-[#000000] bg-neutral-100 p-8 lg:scale-[1.03] lg:origin-top transition-transform">
              <span className="absolute -top-3.5 left-8 inline-flex items-center gap-1 rounded-full bg-[#000000] px-3 py-1 text-[10px] font-bold uppercase tracking-wide text-white">
                Populärast
              </span>
              <h2 className="text-xl font-bold text-[#000000]">Standard</h2>
              <p className="mt-1 text-sm text-[#000000]/60">
                För företag som vill automatisera sin bokföring
              </p>
              <div className="mt-6">
                <div className="flex items-baseline gap-1">
                  <span className="text-5xl font-extrabold tracking-tight text-[#000000] tabular-nums">
                    199 kr
                  </span>
                  <span className="text-lg text-[#000000]/50">/mån</span>
                </div>
                <p className="mt-2 text-sm text-[#000000]/60">
                  Därefter 399 kr/mån · Introerbjudande
                </p>
                <p className="mt-1 text-xs text-[#000000]/40">Exkl. moms</p>
              </div>
              <button
                onClick={() => navigate("/auth")}
                className="mt-6 inline-flex h-12 w-full items-center justify-center gap-2 rounded-md bg-[#000000] text-[15px] font-bold text-white transition-all duration-200 hover:scale-[1.02] hover:bg-[#000000] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#000000] focus-visible:ring-offset-2"
              >
                Kom igång gratis
                <ArrowRight className="h-4 w-4" aria-hidden />
              </button>
              <p className="mt-3 text-center text-xs text-[#000000]/50">
                14 dagar gratis · Ingen bindningstid
              </p>
              <div className="mt-6 border-t-2 border-[#000000]/15 pt-6">
                <p className="mb-3 text-[10px] font-semibold uppercase tracking-wider text-[#000000]/50">
                  Vad som ingår
                </p>
                {standardFeatures.map((f) => (
                  <FeatureItem key={f} text={f} onBlue />
                ))}
                <p className="mt-3 text-[11px] italic text-[#000000]/50">
            ...
            <div className="relative rounded-lg bg-gray-100 p-8">
              <span className="absolute top-4 right-4 rounded-full bg-white px-3 py-1 text-[10px] font-semibold uppercase tracking-wide text-[#000000]/60">
                För specifika behov
              </span>
              <h2 className="text-xl font-bold text-[#000000]">Enterprise</h2>
              <p className="mt-1 pr-24 text-sm text-[#000000]/60">
                För dig som behöver något utöver standard — anpassad kontoplan,
                egna integrationer eller skräddarsydd implementation.
              </p>
              <div className="mt-6">
                <div className="text-3xl font-extrabold tracking-tight text-[#000000]">
                  Anpassat pris
                </div>
                <p className="mt-2 text-sm text-[#000000]/60">
                  Baserat på antal klienter, användare och behov
                </p>
                <p className="mt-1 text-xs text-[#000000]/40">Vi återkommer inom 24h</p>
              </div>
              <button
                onClick={() => (window.location.href = "mailto:kontakt@bokfy.se")}
                className="mt-6 h-12 w-full rounded-md border-2 border-[#000000] bg-transparent text-[15px] font-bold text-[#000000] transition-colors duration-200 hover:bg-[#000000] hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#000000] focus-visible:ring-offset-2"
              >
                Boka demo →
              </button>
              <p className="mt-3 text-center text-xs text-[#000000]/50">
        ...
        <section className="bg-gray-100 py-20">
          <div className="mx-auto max-w-2xl px-6">
            <h2 className="mb-10 text-center text-3xl font-extrabold tracking-tight text-[#000000]">
              Vanliga frågor
            </h2>
            <div>
              {faqs.map((f, i) => {
                ...
                return (
                  <div
                    ...
                    className={`border-b-2 py-5 transition-colors duration-200 ${
                      open ? "border-[#000000]" : "border-gray-200"
                    }`}
                  >
                    <button
                      type="button"
                      ...
                      aria-expanded={open}
                      className="flex w-full items-center justify-between rounded-md text-left focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#000000] focus-visible:ring-offset-2"
                    >
                      <span
                      ...
                      <ChevronDown
                        ...
                        className={`h-4 w-4 shrink-0 transition-transform duration-200 ${
                          open ? "rotate-180 text-[#000000]" : "text-[#000000]/40"
                        }`}
                      />
                    </button>
                    {open && (
                      <p className="mt-3 text-[14px] leading-relaxed text-[#000000]/60">
                        {f.a}
                      </p>
                    )}
                  </div>
        ...
        <section className="relative overflow-hidden bg-[#000000] py-20 text-center">
          <div
            aria-hidden
          ...
          <div className="relative px-6">
            ...
            <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
              <button
                onClick={() => navigate("/auth")}
                className="inline-flex h-12 items-center gap-2 rounded-md bg-[#000000] px-8 font-bold text-white transition-all duration-200 hover:scale-105 hover:bg-[#000000] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-[#000000]"
              >
                Kom igång gratis
                <ArrowRight className="h-4 w-4" aria-hidden />
              </button>
              <button
                onClick={() => (window.location.href = "mailto:kontakt@bokfy.se")}
                className="h-12 rounded-md border-2 border-white/60 bg-transparent px-8 font-semibold text-white transition-colors duration-200 hover:bg-white hover:text-[#000000] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-[#000000]"
              >
                Boka demo
              </button>
            </div>

  ...
  return (
    <div className="relative">
      <main className="container mx-auto px-4 py-5 space-y-4 max-w-[1500px]">
        ...
        {!loading && kpi && (
          <div className="rounded-xl border bg-gradient-to-r from-[#0052FF]/5 via-transparent to-transparent px-4 py-3 flex items-center justify-between gap-3 flex-wrap">
            ...
            <Button
              size="sm"
              variant="outline"
              className="h-8 text-xs border-[#C8DDF5] text-[#0052FF] dark:text-[#1E3A5F] hover:bg-[#EFF6FF]"
          ...
          <div className="space-y-3">
            <div>
              <h2 className="text-sm font-semibold tracking-tight flex items-center gap-1.5">
                <Radio className="h-3.5 w-3.5 text-[#0052FF]" /> Cash Waterfall — denna månad
              </h2>

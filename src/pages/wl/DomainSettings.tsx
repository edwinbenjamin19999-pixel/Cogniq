    ...
    <div className="container max-w-3xl py-8 space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Konfigurera din egen domän för <strong>{tenant.name}</strong>. Standardadress: <code>{tenant.slug}.ledger.io</code>.
        </p>
      </div>
          ...
          {tenant.domain_status === "verified" && tenant.domain_verified_at && (
            <Alert className="border-[#BFE6D6] bg-[#E1F5EE]">
              ...
              <AlertDescription className="text-sm">
                ...
                Kontakta <a href="mailto:support@ledger.io" className="underline font-medium">support@ledger.io</a> för att aktivera SSL och slutföra driftsättningen.
              </AlertDescription>
            </Alert>
          )}
        </CardContent>

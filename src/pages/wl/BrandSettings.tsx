    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center gap-3 p-8 text-center">
        ...
        <p className="text-muted-foreground text-sm max-w-md">
          Brand Settings är tillgängligt på din egen subdomän (t.ex. <span className="font-mono">dittnamn.ledger.io</span>). Den här sidan är inte tillgänglig på huvuddomänen.
        </p>

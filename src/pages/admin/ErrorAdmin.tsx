  ...
  return (
    <div className="p-[20px] space-y-[20px] max-w-[1400px] mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-[12px]">
        <KpiCard label="Totala fel (denna vecka)" value={kpis.total} accent="#000000" />
        <KpiCard
          label="Auto-fixade"
          value={kpis.fixed}
          accent="#1D9E75"
        ...
        <KpiCard
          ...
          value={kpis.manual}
          accent={kpis.manual > 0 ? "#525252" : "#94A3B8"}
        ...
        <div className="flex items-center gap-[8px]">
          <div className="relative">
            ...
            <input
              ...
              className="pl-[30px] pr-[12px] h-[32px] text-[12px] border-[0.5px] border-[#E2E8F0] rounded-[8px] bg-white w-[260px] focus:outline-none focus:border-[#000000]"
            />
          </div>
          <select
            value={range}
            onChange={(e) => setRange(e.target.value as RangeKey)}
            className="h-[32px] text-[12px] border-[0.5px] border-[#E2E8F0] rounded-[8px] bg-white px-[10px] focus:outline-none focus:border-[#000000]"
          >
      ...
      <tr className="border-t-[0.5px] border-[#E2E8F0] hover:bg-[#F8FAFB] cursor-pointer" onClick={onToggle}>
        ...
        <td className="px-[14px] py-[10px] text-right">
          <button
            ...
            className="text-[11px] text-[#94A3B8] hover:text-[#000000]"
                ...
                {row.fix_analysis ? (
                  <>
                    ...
                    <div className="flex flex-wrap gap-[8px] pt-[4px]">
                      <button
                        ...
                        className="bg-[#000000] hover:bg-[#1074A0] disabled:opacity-50 disabled:cursor-not-allowed text-[#E6F4FA] rounded-[8px] text-[12px] font-medium px-[14px] h-[36px] inline-flex items-center gap-[6px]"
                      >
                      ...
                      <button
                        ...
                        className="text-[12px] text-[#94A3B8] hover:text-[#000000] px-[8px] h-[36px]"
                      >
                        Markera som löst
                      </button>
                    </div>
                  ...
                  <div className="space-y-[8px]">
                    ...
                    <button
                      onClick={onAnalyze}
                      disabled={analyzing}
                      className="bg-[#000000] hover:bg-[#1074A0] disabled:opacity-60 text-[#E6F4FA] rounded-[8px] text-[12px] font-medium px-[14px] h-[36px] inline-flex items-center gap-[6px]"
                    >
                      {analyzing ? (

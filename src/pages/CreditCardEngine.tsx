  ...
  return (
    ...
    >
      ...
      {!selectedCompanyId ? (
        ...
        <Card className="rounded-2xl border-l-[3px] border-l-[#0052FF] p-10 text-center bg-white">
          <Sparkles className="h-10 w-10 text-[#0052FF] mx-auto mb-3" />
            ...
            <div className="flex items-center justify-between mb-4 flex-wrap gap-3">
              <Tabs value={activeTab} onValueChange={(v) => setActiveTab(v as any)}>
                <TabsList>
                  ...
                  <TabsTrigger value="ready" className="data-[state=active]:text-[#0052FF]">
